            ...
            <div className="p-4 md:p-8">
                <div className="max-w-7xl mx-auto">
                    <Header
                        ...
                        subtitle="Gestiona tus deudas, gastos fijos y suscripciones en un solo lugar."
                    >
                        <button
                        ...
                        {loading ? (
                            ...
                            <ul className="divide-y divide-neutral-200">
                                {filteredPayments.map(payment => (
                                    <li key={payment.id} className="grid grid-cols-[1fr_auto] items-center gap-4 p-4 hover:bg-neutral-50">
                                        {/* -- Main content area -- */}
                                        <div className="overflow-hidden">
                                            <div className="flex items-center">
                                                <PaymentTypeBadge type={payment.type} />
                                                <p className="font-semibold text-neutral-800 truncate">{payment.name}</p>
                                            </div>
                                            <div className="mt-1">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <button
                                                ...
                                                className="text-sm bg-neutral-200 hover:bg-neutral-300 text-neutral-800 font-semibold py-1 px-3 rounded-lg transition-colors flex-shrink-0"
                                            >
                                                Editar
                                            </button>
                                            <button
                                                onClick={() => handleDelete(payment.id)}
                                                className="text-sm bg-red-500 hover:bg-red-600 text-white font-semibold py-1 px-3 rounded-lg transition-colors flex-shrink-0"
                                            >
                                                Eliminar
                                            </button>
                                        </div>
